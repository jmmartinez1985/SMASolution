...
(function ($) {
    ...
    function upload() {
        ...
        function send(e) {
                ...
                success: function (data, textStatus, jqXHR) {
                    if (jqXHR.responseText) {
                        var now = new Date().getTime(),
                            ...
                            result = opts.uploadFinished(index, file, jQuery.parseJSON(jqXHR.responseText), timeDiff, droptarget);
                        filesDone++;
            ...
            //        var now = new Date().getTime(),
            //            timeDiff = now - start_time,
            //            result = opts.uploadFinished(index, file, jQuery.parseJSON(xhr.responseText), timeDiff, droptarget);
            //        filesDone++;
            //        if (filesDone == files_count - filesRejected) {
            //            afterAll();
            //        }
