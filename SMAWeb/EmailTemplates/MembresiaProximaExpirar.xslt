      ...
      <body>
        ...
        <div class="another-page">
          <div class="headline">
            ...
            <h3>Membresía Próxima a Expirar</h3>
          </div>
          <h5>
            Estimado(a) <xsl:value-of select="UserName"/> :
          </h5>
          <br />
          <h5>
            Service Market le informa que su membresía está próxima a expirar. Si desea extender su membresía haga clic en el siguiente link:
            <xsl:element name="a">
