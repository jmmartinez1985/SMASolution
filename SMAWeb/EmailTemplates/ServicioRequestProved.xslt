    ...
    <html>
      ...
      <body>
        ...
        <div class="another-page">
          ...
          <br />
          <h5>
            <strong class="color-green">Nombre: </strong>
            <xsl:value-of select="CustomerName" />
          </h5>
          <h5>
            <strong class="color-green">Correo: </strong>
          ...
          <br />
          <h5>Le solicitamos por favor atender a esta solicitud, y en caso de no poder brindar el servicio recuerde notificar al usuario solicitante.</h5>
          <br />
          <br />
          <h5>Atentamente,</h5>
