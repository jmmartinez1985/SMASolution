    ...
    <html>
      ...
      <body>
        ...
        <div class="another-page">
          ...
          <br />
          <h5>
            Le informamos que la solicitud de servicio número <xsl:value-of select="SolicitudId" /> ha sido cancelada por el anunciante.
          </h5>
          <h5>
            Le pedimos disculpas en nombre del anunciante y le invitamos a que siga disfrutando de Service Market.
          </h5>
          <br />
          <br />
          <h5>Atentamente,</h5>
